package io.github.zeroornull.cache;
...
public class ActivityLocalCache extends AbstractGuavaCache<String, SeckillActivityDTO> implements
    ILocalCache<String, SeckillActivityDTO> {
    ...
    /**
     * 本地缓存不存在时，用于加载数据到本地缓存 注：在加载数据时，只有一个请求去加载，其他的在等待，这样可以避免并发时请求都到达目标接口
     *
     * @param key
     * @return
     */
